<template>
  <div class="datenschutz">
    ...
    <p>
      ...
      Otto-Ostrowski-Stra&szlig;e 7, 10249 Berlin (nachfolgend
      &bdquo;Strato&ldquo;). Wenn Sie unsere Website besuchen, erfasst Strato
...
@media only screen and (min-width: 1264px) {
  .datenschutz {
    padding: 2em calc((100% - var(--desktop-max-width)) / 2);
  }
}
</style>